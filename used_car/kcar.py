...
class UsedCar:
    ...
    # 'car_name3': 
    #     "/html/body/div[2]/section/div[2]/form[2]/section[1]/div[3]/div[1]/div[2]/div/div/div[1]/ul/li/ul/li/ul/li[4]/ul/li[2]",
    # 'car_name4': 
    #     "/html/body/div[2]/section/div[2]/form[2]/section[1]/div[3]/div[1]/div[2]/div/div/div[1]/ul/li/ul/li/ul/li[4]/ul/li[13]",
    # 'car_name5': 
    #     "/html/body/div[2]/section/div[2]/form[2]/section[1]/div[3]/div[1]/div[2]/div/div/div[1]/ul/li/ul/li/ul/li[4]/ul/li[17]",
    'car_year_sel': 
    ...
    'car_opt_confirm': 
        ...
        if LOAD_WEB_PAGE:
            ...
            for key in xpath_dict.keys():
                ...
                # if key.find('car_name') > 0: time.sleep(2)

                if key == 'car_opt': time.sleep(3)



            # 캡쳐하기 전에 옵션 정보를 보기 위해 스크롤을 상단으로 올림.
